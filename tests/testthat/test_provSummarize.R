...
expect_equal(summary[26:36], expected.summary[26:36])
expect_equal(summary[38], expected.summary[38])
expect_equal(summary[40], expected.summary[40])
expect_equal(summary[42:46], expected.summary[42:46])
